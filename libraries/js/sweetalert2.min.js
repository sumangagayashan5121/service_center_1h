!function (e, t) {
    ...
    var e = {
        ...
        o = t(["success", "warning", "info", "question", "error"]), r = function (e, t) {
            ...
            t && t.parentNode.removeChild(t);
            {
                if ("undefined" != typeof document) {
                    ...
                    var r = c(), i = B(r, n.input), a = B(r, n.file), l = r.querySelector("." + n.range + " input"),
                        d = r.querySelector("." + n.range + " output"), p = B(r, n.select),
                        f = r.querySelector("." + n.checkbox + " input"), m = B(r, n.textarea);
        ...
        u = function () {
            ...
            var p = f(), y = m(), k = h(), x = g(), S = w(), B = C();
            if (e.titleText ? p.innerText = e.titleText : p.innerHTML = e.title.split("\n").join("<br />"), e.text || e.html) {
                if ("object" === I(e.html)) if (y.innerHTML = "", 0 in e.html) for (var q = 0; q in e.html; q++) y.appendChild(e.html[q].cloneNode(!0)); else y.appendChild(e.html.cloneNode(!0)); else e.html ? y.innerHTML = e.html : e.text && (y.textContent = e.text);
                P(y)
            } else L(y);
            e.showCloseButton ? P(B) : L(B), t.className = n.modal, e.customClass && A(t, e.customClass);
            var V = b(), O = parseInt(null === e.currentProgressStep ? $.getQueueStep() : e.currentProgressStep, 10);
            e.progressSteps.length ? (P(V), T(V), O >= e.progressSteps.length && console.warn("SweetAlert2: Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), e.progressSteps.forEach(function (t, o) {
                ...
                if (A(r, n.progresscircle), r.innerHTML = t, o === O && A(r, n.activeprogressstep), V.appendChild(r), o !== e.progressSteps.length - 1) {
                    var i = document.createElement("li");
                    A(i, n.progressline), i.style.width = e.progressStepsDistance, V.appendChild(i)
                }
            })) : L(V);
            ...
            return new Promise(function (t, o) {
                ...
                window.onkeydown && window.onkeydown.toString() === D.toString() || (a.previousWindowKeyDown = window.onkeydown, window.onkeydown = D), l.buttonsStyling && (N.style.borderLeftColor = l.confirmButtonColor, N.style.borderRightColor = l.confirmButtonColor), e.hideLoading = e.disableLoading = function () {
                    l.showConfirmButton || (L(N), l.showCancelButton || L(h())), E(H, n.loading), E(d, n.loading), N.disabled = !1, R.disabled = !1
                }, e.getTitle = function () {
                    return f()
                    ...
                    var o = i();
                    o && (o.removeAttribute("aria-invalid"), o.removeAttribute("aria-describedBy"), E(o, n.inputerror))
                ...
                for (var _ = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], Z = void 0, Q = 0; Q < _.length; Q++) {
                    var Y = n[_[Q]], $ = B(d, Y);
                    if (Z = i(_[Q])) {
                        for (var J in Z.attributes) if (Z.attributes.hasOwnProperty(J)) {
                    ...
                    $.className = Y, l.inputClass && A($, l.inputClass), L($)
                }
                var G = void 0;
                switch (l.input) {
                    case"text":
                    ...
                    case"file":
                        ...
                        break;
                    case"range":
                        var ee = B(d, n.range), te = ee.querySelector("input"), ne = ee.querySelector("output");
                    ...
                    case"radio":
                        ...
                        break;
                    case"checkbox":
                        var ae = B(d, n.checkbox), le = i("checkbox");
    ...
    return $.isVisible = function () {
        ...
        var t = u(), o = c();
        if (o) {
            E(o, n.show), A(o, n.hide), clearTimeout(o.timeout), H();
            var r = function () {
                t.parentNode && t.parentNode.removeChild(t), E(document.documentElement, n.shown), E(document.body, n.shown), Z(), Y()
            };
        ...
        e || $("");
        var t = h(), o = g(), r = w();
        P(t), P(o, "inline-block"), A(t, n.loading), A(e, n.loading), o.disabled = !0, r.disabled = !0
