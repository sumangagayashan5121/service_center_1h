<div class="card small">
	<div class="card-header form-group">
		<div class="col-sm-6">
			<h5 class="col-xs-12">Performer Invoice</h5>
		</div>
	</div>
	<form id="form" action="<?=base_url()?>index.php/PerformerinvoiceController/save_performer_invoice" method="post">
		<div class="card-body">
			<div class="row form-group">
				...
				<div class="col-md-6">
					...
					<input type="text" class="form-control" id="booking_id" onchange="search_booking_id()"  required name="booking_id">
				</div>
			</div>
