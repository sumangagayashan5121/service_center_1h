...
<div class="denied__wrapper">
	<h1>403</h1>
	<h3>LOST IN <span>SPACE</span> HRMS? Hmm, looks like permission denied.</h3>
	...
	<a href="<?=base_url()?>index.php/LoginController/home"><button class="denied__link">Go Home</button></a>
</div>
